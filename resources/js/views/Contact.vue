        ...
        <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            <div
                ...
                <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                    ...
                    <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                        ...
                        <a class="text-indigo-500 leading-relaxed">* geheim *</a>
            ...
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                ...
                <form @submit.prevent="submitForm">
                    ...
                    <input type="submit"
                        class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" value="Verstuur">
...
export default {
    ...
    methods: {
        submitForm() {
            this.axios.post('http://webnlblog.digicate.nl/api/contact', this.form)
                .then((res) => {
